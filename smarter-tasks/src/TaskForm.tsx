    ...
    <form onSubmit={addTask}>
      <div className="border-b-2 border-blue-800">
        ...
        <div className="relative z-0 w-full mb-6 group">
          ...
          id="addTaskButton"
            type="submit"
            className=" bg-yellow-300 hover:bg-yellow-200 focus:ring-4 focus:outline-none focus:ring-blue-300 font-medium rounded-lg text-sm w-full sm:w-auto px-5 py-2.5 text-center dark:bg-yellow-300 dark:hover:bg-yellow-200 dark:focus:ring-blue-800"
          >
            Add item
          </button>
        </div>
